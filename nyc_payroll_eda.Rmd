...
```
```{r}
nypd_consolidated_titles <- nypd_data %>%
  mutate(title_description = cont
...
ggplot(data = nypd_data, aes(gender))+ ## Employees by Year (Gender)
  geom_bar(na.rm = TRUE)+
...
nypd_data %>%  ## -- Lollipop top 10 female jobs + Median Pay / IQR
